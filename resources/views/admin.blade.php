                    ...
                    <nav id="sidebar">
                        ...
                        <div class="sidebar-header">
                            <div class="logo_section">
                                <a href="index.html"><img class="logo_icon img-responsive" src="{{ asset('/adminassets/assets/images/logo/logo_icon.png') }}" alt="#" /></a>
                            </div>
                        </div>
                        <div class="sidebar_user_info">
                            <div class="icon_setting"></div>
                            <div class="user_profle_side">
                                <div class="user_img"><img class="img-responsive" src="{{ asset('/adminassets/assets/images/layout_img/user_img.jpg') }}" alt="#" /></div>
                                <div class="user_info">
                                    <h6>John David</h6>
                        ...
                        <ul class="list-unstyled components">
                            ...
                            <li><a href="widgets.html"><i class="fa fa-clock-o orange_color"></i> <span>Post a Property</span></a></li>
                            <li>
                                <a href="#element" data-toggle="collapse" aria-expanded="false"><i class="fa fa-diamond purple_color"></i> <span>My Listings</span></a>

                            </li>
                            <li><a href="tables.html"><i class="fa fa-table purple_color2"></i> <span>Tables</span></a></li>
                            <li>
                                <a href="#apps" data-toggle="collapse" aria-expanded="false"><i class="fa fa-object-group blue2_color"></i> <span>Client Request</span></a>

                            </li>
                            <li><a href="price.html"><i class="fa fa-briefcase blue1_color"></i> <span>Subscription</span></a></li>
                            <li>
                                <a href="contact.html">
                                <i class="fa fa-paper-plane red_color"></i> <span>Call Back Request</span></a>
                            </li>
                            <li class="active">
                                <a href="#additional_page" data-toggle="collapse" aria-expanded="false"><i class="fa fa-clone yellow_color"></i> <span>My Messages</span></a>

                            </li>
                            <li><a href="map.html"><i class="fa fa-map purple_color2"></i> <span>Favourites</span></a></li>
                            <li><a href="#"><i class="fa fa-bar-chart-o green_color"></i> <span>Logout</span></a></li>
                    ...
                    <div id="content">
                        ...
                        <div class="topbar">
                            ...
                            <div class="full">
                                ...
                                <div class="logo_section">
                                    <a href="index.html">
                                        {{-- <img class="img-responsive" src="adminassets/assets/images/logo/logo.png" alt="#" /></a> --}}
                                    <h1 class="text-light mx-5 mt-3">CityNest Admin Dashboard</h1>
                                </div>
                                <div class="right_topbar">
                                    <div class="icon_info">
                                        ...
                                        <li>
                                            <a class="dropdown-toggle" data-toggle="dropdown"><img class="img-responsive rounded-circle" src="adminassets/assets/images/layout_img/user_img.jpg" alt="#" /><span class="name_user">John David</span></a>
